...
(function () {
  ...
  // Anti-spam : vrai uniquement si la case piège a été cochée (par un robot)
  function botCoche(form) {
    var h = form.querySelector('[name="botcheck"]');
    return !!(h && h.checked);
  }
  ...
  if (contact) {
    ...
    contact.addEventListener('submit', function (e) {
      ...
      if (botCoche(contact)) return; // robot
